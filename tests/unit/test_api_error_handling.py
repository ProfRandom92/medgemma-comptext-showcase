...
class TestApiErrorHandling:
    ...
    def test_missing_clinical_text_returns_422(self):
    ...
    def test_clinical_text_null_returns_422(self):
        """[Test] Null clinical_text returns 422"""
        payload = {"clinical_text": None}
        response = client.post("/api/process", json=payload)
        assert response.status_code == 422

    def test_clinical_text_empty_string_returns_422(self):
        """[Test] Empty string clinical_text returns 422"""
        payload = {"clinical_text": ""}
        response = client.post("/api/process", json=payload)
        assert response.status_code == 422

    def test_clinical_text_whitespace_only_returns_422(self):
    ...
    def test_clinical_text_below_min_length_returns_422(self):
        """[Test] Text below 10 char minimum returns 422"""
        payload = {"clinical_text": "short"}  # 5 chars
        response = client.post("/api/process", json=payload)
        assert response.status_code == 422

    def test_clinical_text_at_min_length_returns_200(self):
        """[Test] Text at 10 char minimum returns 200"""
        payload = {"clinical_text": "short text"}  # Exactly 10 chars
        response = client.post("/api/process", json=payload)
        assert response.status_code == 200

    def test_clinical_text_exceeds_max_length_returns_413(self):
        """[Test] Text exceeding 5000 char limit returns 413"""
        payload = {"clinical_text": "x" * 5001}
        response = client.post("/api/process", json=payload)
        assert response.status_code == 413, "Should return 413 for oversized payload"

    def test_clinical_text_at_max_length_returns_200(self):
    ...
    def test_json_with_extra_comma_returns_400(self):
        """[Test] JSON with syntax error returns 400"""
        response = client.post(
            "/api/process",
    ...
    def test_invalid_patient_id_format_returns_422(self):
    ...
    def test_valid_patient_id_format_returns_200(self):
    ...
    def test_invalid_document_source_enum_returns_422(self):
    ...
    def test_valid_document_source_enum_returns_200(self):
    ...
    def test_all_valid_optional_fields_returns_200(self):
    ...
    def test_unicode_characters_handled_gracefully(self):
    ...
    def test_special_medical_symbols_preserved(self):
    ...
    def test_null_bytes_in_text_handled(self):
    ...
    def test_10_sequential_requests_all_succeed(self):
    ...
    def test_error_response_has_proper_structure(self):
    ...
    def test_successful_response_has_required_fields(self):
    ...
    def test_clinical_text_with_newlines_and_tabs(self):
    ...
    def test_response_time_under_error_conditions(self):
    ...
    def test_many_requests_dont_cause_server_overload(self):
